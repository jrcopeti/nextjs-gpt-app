    ...
    <div className="relative h-screen">
      ...
      <section className="z-0 flex flex-col items-center justify-center lg:p-4">
        <div className="flex max-w-[90%] flex-col items-center justify-center gap-4 pt-[20rem] text-center md:pt-[18rem] lg:pt-[14rem]  ">
          {/* <h1 className="  text-7xl font-extrabold text-slate-700 lg:text-9xl">
            {props.title}
          </h1> */}
          <h1 className=" inline-block bg-gradient-to-r from-slate-600 via-slate-500 to-slate-400 bg-clip-text font-bold text-7xl text-transparent lg:text-9xl">
            {props.title}
          </h1>
